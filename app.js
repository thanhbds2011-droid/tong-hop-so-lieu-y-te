...
var AUTO_SYNC_MS = 300000;
    ...
    function updateEntryDateLabel(){
      // Phiên bản 8.3.5 chỉ hiển thị ngày tại bộ chọn ngày, không lặp lại ngày ở các khối nội dung.
    }
    ...
    async function initializeUi(){
      window.parent.postMessage({type:'YTE_APP_READY',version:'8.3.5'},'*');setupDates();updateRangeFields();
